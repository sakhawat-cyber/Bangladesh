            ...
            Column(
              children: [
                ...
                Center(
                  child: TextButton(
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) =>kaligong()));
                    },
                    child: Text(
                      "কালীগঞ্জ",
                      style:
                ...
                Center(
                    child: TextButton(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) =>kaliyakir()));
                  },
                ...
                Center(
                    child: TextButton(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) =>kaspia()));
                  },
                  child: Text("কাপাসিয়া",
                      style:
                          TextStyle(fontSize: 20, fontWeight: FontWeight.w900)),
                ...
                Center(
                    child: TextButton(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) =>gazipurSadar()));
                  },
                ...
                Center(
                    child: TextButton(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) =>sripur()));
                  },
                  child: Text("শ্রীপুর",
                      style:
                          TextStyle(fontSize: 20, fontWeight: FontWeight.w900)),
