            ...
            Column(
              children: [
                ...
                Center(
                  child: TextButton(
                    onPressed: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) =>bashil()));
                    },
                    child: Text(
                      "বাসাইল",
                      style:
                ...
                Center(
                    child: TextButton(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) =>bouapur()));
                  },
                  child: Text("ভুয়াপুর",
                      style:
                          TextStyle(fontSize: 20, fontWeight: FontWeight.w900)),
                ...
                Center(
                    child: TextButton(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) =>ghatil()));
                  },
                  child: Text("ঘাটাইল",
                      style:
                          TextStyle(fontSize: 20, fontWeight: FontWeight.w900)),
                ...
                Center(
                    child: TextButton(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) =>golappur()));
                  },
                  child: Text("গোপালপুর",
                      style:
                          TextStyle(fontSize: 20, fontWeight: FontWeight.w900)),
                ...
                Center(
                    child: TextButton(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) =>mdupur()));
                  },
                  child: Text("মধুপুর",
                      style:
                          TextStyle(fontSize: 20, fontWeight: FontWeight.w900)),
                ...
                Center(
                    child: TextButton(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) =>mirjapur()));
                  },
                ...
                Center(
                    child: TextButton(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) =>nagurpur()));
                  },
                  child: Text("নাগরপুর",
                      style:
                          TextStyle(fontSize: 20, fontWeight: FontWeight.w900)),
                ...
                Center(
                    child: TextButton(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) =>shakhipur()));
                  },
                  child: Text("সখিপুর",
                      style:
                          TextStyle(fontSize: 20, fontWeight: FontWeight.w900)),
                ...
                Center(
                    child: TextButton(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) =>tangialSodor()));
                  },
                ...
                Center(
                    child: TextButton(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) =>kalihati()));
                  },
                  child: Text("কালিহাতী",
                      style:
                          TextStyle(fontSize: 20, fontWeight: FontWeight.w900)),
                ...
                Center(
                    child: TextButton(
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) =>dhonbari()));
                  },
                  child: Text("ধনবাড়ী",
                      style:
                          TextStyle(fontSize: 20, fontWeight: FontWeight.w900)),
            ...
            children: [
              ...
              Text(
                "ভূগোল:  ঘাটাইল উপজেলার ভৌগোলিক অবস্থান অবস্থান ২৪°২৩´ থেকে ২৪°৩৪´ উত্তর অক্ষাংশ এবং ৮৯°৫৩´ থেকে ৯০°১৫´ পূর্ব দ্রাঘিমাংশ। এটি টাঙ্গাইল ও ময়মনসিংহ জেলার মহাসড়কের দুপাশে এবং টাঙ্গাইল জেলার উত্তরে অবস্থিত। এর মোট আয়তন ৪৫১.৭১ বর্গ কিলোমিটার। এটি সমুদ্র পৃষ্ঠ থেকে ১৮ মিটার উচ্চতায় অবস্থিত। পুরো উপজেলাটি বনাঞ্চল বেষ্টিত পাহাড়ি জনপদ নিয়ে গঠিত। ভৌগোলিকভাবে ঘাটাইলের মাটি লাল। ঘাটাইল উপজেলার কেন্দ্র থেকে দক্ষিণে টাঙ্গাইল, পশ্চিমে সিরাজগঞ্জ এবং উত্তরে ময়মনসিংহ জেলা সদর অবস্থিত। টাঙ্গাইল জেলা সদর ঘাটাইলের দূরুত্ব ৩০ কিলোমিটার। এর উত্তরে গোপালপুর ও মধুপুর উপজেলা, দক্ষিণে কালিহাতি ও সখিপুর উপজেলা, পূর্বে ময়মনসিংহ জেলার ফুলবাড়িয়া ও ভালুকা উপজেলা, পশ্চিমে ভুঞাপুর ও গোপালপুর উপজেলা অবস্থিত।\n\n"
                    ...
                    "অর্থনীতি:  ঘাটাইল মূলত কৃষিপ্রধান অঞ্চল। এ অঞ্চলের ৬৪.৭৫% জনগোষ্ঠীর আয়ের প্রধান উৎস কৃষি। প্রধান কৃষি ফসলের মধ্যে রয়েছে ধান, পাট, আখ, সরিষা, ডাল, আদা, হলুদ, বাদাম, শাকসবজি। পূর্বে এ অঞ্চলে রসুন, তিল, তিসি ও গমের আবাদ করা হত। এছাড়াও এখানে কলা, কাঁঠাল, আনারস, আম, তরমুজ, পেঁপে এবং জাম বাণিজ্যিকভাবে চাষ হয়। ২০০১ সালের ভূমিজরিপ অনুসারে উপজেলার ৬৮.৩৪% পরিবার কৃষিজমির মালিক।[২১] উপজেলায় মোট ৩১৫০ হেক্টর আবাদি জমি রয়েছে।\n\n"
            ...
            children: [
              ...
              Text(
                "অবস্থান ও আয়তন:  এই উপজেলার ভৌগোলিক স্থানাংক আয়তন: ২৬৬.৭৭ বর্গ কিমি। অবস্থান: ২৩°৫৮´ থেকে ২৪°১০´ উত্তর অক্ষাংশ এবং ৮৯°৪৬´ থেকে ৯০°০১´ পূর্ব দ্রাঘিমাংশ । এই উপজেলার পূর্বে- মির্জাপুর উপজেলা, সাটুরিয়া উপজেলা, পশ্চিমে - চৌহালি উপজেলা, দৌলতপুর উপজেলা, উত্তরে- টাঙ্গাইল সদর উপজেলা ও দেলদুয়ার উপজেলা , দক্ষিণে- মানিকগঞ্জ জেলার দৌলতপুর উপজেলা ।\n\n"
                    ...
                    "জনসংখ্যার উপাত্ত:  জনসংখ্যা ২৫৮৪৩১; পুরুষ ১২৬৮৮১, মহিলা ১৩১৫৫০। মুসলিম ২৩৯১১৫, হিন্দু ১৯২৯৫, বৌদ্ধ ৮ এবং অন্যান্য ১৩ জন ।\স\স"
                    "শিক্ষা:  শিক্ষার হার  ৩৪.৭%; পুরুষ ৪০.০%, মহিলা ২৯.৭%। কলেজ ৩, মাধ্যমিক বিদ্যালয় ৩০, প্রাথমিক বিদ্যালয় ১৫৭, মাদ্রাসা ১৬\স\স"
                    "অর্থনীতি:  জনগোষ্ঠীর আয়ের প্রধান উৎস কৃষি ৬১.৬৩%, অকৃষি শ্রমিক ৩.২২%, শিল্প ১.০৭%, ব্যবসা ১১.২০%, পরিবহন ও যোগাযোগ ১.৬৬%, চাকরি ১০.৫০%, নির্মাণ ০.৭৪%, ধর্মীয় সেবা ০.২৬%, রেন্ট অ্যান্ড রেমিটেন্স ০.৯৪% এবং অন্যান্য ৮.৭৮%। পানীয়জলের উৎস নলকূপ ৯২.৯৭%, পুকুর ০.২২%, ট্যাপ ০.৩৬% এবং অন্যান্য ৬.৪৫%।\স\স"
            ...
            children: [
              ...
              Text(
                "অবস্থান:  ১৯৮৩ সালে উপজেলা হিসেবে প্রতিষ্ঠিত ৪২৯.৭৮ বর্গকিমি ও ১৩২টি গ্রামের সখিপুর বাংলাদেশের টাঙ্গাইল জেলার ১২টি উপজেলার মধ্যে অন্যতম। এই উপজেলার ভৌগোলিক স্থানাক ২৪.৩১৬৭° উত্তর ৯০.১৭৫০° পূর্ব। এর উত্তরে ঘাটাইল উপজেলা, দক্ষিণে মির্জাপুর ও গাজীপুরের কালিয়াকৈর উপজেলা, পূর্বে ময়মনসিংহের ভালুকা উপজেলা এবং পশ্চিমে কালিহাতি ও বাসাইল উপজেলা অবস্থিত।\n\n"
                    ...
                    "প্রশাসনিক এলাকা:  সখিপুর উপজেলায় রয়েছে ১টি পৌরসভা এবং ০৮ টি ইউনিয়ন রয়েছে।\স\স"
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Text(
                "অবস্থান:  এই উপজেলার স্থানাঙ্ক ২৪.২৫০০° উত্তর ৮৯.৯১৬৭° পূর্ব। এর উত্তরে কালিহাতি উপজেলা, পূর্বে বাসাইল ও সখিপুর উপজেলা, দক্ষিণে দেলদুয়ার ও নাগরপুর উপজেলা এবং পশ্চিমে সিরাজগঞ্জ জেলা অবস্থিত।\স\স"
            ...
            children: [
              ...
              Text(
                "ভূগোল:  ধনবাড়ী উপজেলার ভৌগোলিক অবস্থান ২৪.৬৮০৫৭৮৪° উত্তর ৮৯.৯৩৯১৮৪১° পূর্ব অর্থাৎ ২৩°৩৭´ থেকে ২৪°৪৫´ উত্তর অক্ষাংশ এবং ৯০°১০´ থেকে ৯০°০০´ পূর্ব দ্রাঘিমাংশ। এটি মধুপুর উপজেলা ও জামালপুর জেলার সংযোগ সড়কের দুপাশে অবস্থিত। এর মোট আয়তন ১৩০.৫০ বর্গকিলোমিটার। ভৌগোলিকভাবে ধনবাড়ীর মাটি মধুপুর কর্দম দিয়ে গঠিত। ধনবাড়ী উপজেলার কেন্দ্র থেকে উত্তরে জামালপুর জেলা, পূর্বে মধুপুর উপজেলা, দক্ষিণে গোপালপুর উপজেলা এবং পশ্চিমে জামালপুর জেলার সরিষাবাড়ী উপজেলা অবস্থিত। মধুপুর উপজেলার মধুপুর গড়ের শেষ পশ্চিম অংশ থেকে ধনবাড়ী উপজেলার সীমানা শুরু হয়ে টাঙ্গাইল জেলার উত্তর প্রান্তে শেষ হয়েছে। এ উপজেলার উপর দিয়ে ঝিনাই নদী প্রবাহিত হয়েছে। টাঙ্গাইল জেলা সদর থেকে সড়কপথে ধনবাড়ীর দূরত্ব ৬৩ কিলোমিটার।\n\n"
                    ...
                    "উল্লেখযোগ্য স্থান:  ধনবাড়ীতে বেশ কয়েকটি পর্যটন আকর্ষণ ও ঐতিহাসিক স্থান রয়েছে। যার মধ্যে উল্লেখযোগ্য হল-ধনবাড়ি জমিদার বাড়ি ও ধনবাড়ী মসজিদ - চার গম্বুজবিশিষ্ট মোগল স্থাপত্যরীতিতে তৈরি এই জমিদার বাড়িটি নবাব বাড়ি বা নবাব মঞ্জিল নামেও পরিচিত।[২০] নবাব বাড়ির পাশে রয়েছে ৩০ বিঘার দিঘি ও ধনবাড়ী মসজিদ। ১৯২৯ সালে সৈয়দ নওয়াব আলী চৌধুরীর মৃত্যুর পর থেকে এখানে ২৪ ঘণ্টা ‘কোরআন তিলাওয়াত’ বা পাঠ করা হয় যা কখনো বন্ধ করা হয় না।",
                textAlign: TextAlign.justify,
                style: TextStyle(fontWeight: FontWeight.bold),
              ),
              SizedBox(height: 10),
