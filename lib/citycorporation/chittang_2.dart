...
//chittagongCityCor
class chittagongCityCor extends StatelessWidget {
  const chittagongCityCor({Key? key}) : super(key: key);
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Center(
                  child: Text(
                    "এক নজরে চট্টগ্রাম সিটি কর্পোরেশন",
                    style: TextStyle(fontWeight: FontWeight.w900, fontSize: 20),
                  ),
                ),
              ),
...
//comillaCityCor
class comillaCityCor extends StatelessWidget {
  const comillaCityCor({Key? key}) : super(key: key);
